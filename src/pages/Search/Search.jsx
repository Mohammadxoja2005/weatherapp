...
const Search = () => { 
  ...
  const [submitRequest, todaysWeatherData] = Hook();
  ...
  return(
    ...
    <input type="text" placeholder="search" onChange={((event) => {setLocation(event.target.value)})}/>
  ...
  <div className="socials">
    <a
      className="dribbble"
      href="https://dribbble.com/shots/10879114-Search-animation-Only-CSS"
      target="_blank"
    >
      <svg
